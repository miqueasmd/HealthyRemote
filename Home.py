...
st.sidebar.markdown("<div style='text-align: center; color: #555;'><small>Created by: <b>MMD</b><br><a href='https://portfolio.mmdlab.tech/' target='_blank'>Miqueas Molina Delgado</a></small></div>", unsafe_allow_html=True)
